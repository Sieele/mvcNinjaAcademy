...
namespace mvcAppNinjaDemo.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ImageId,ImageName,ImagePath,NinjaId")] Image image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ImageId,ImageName,ImagePath,NinjaId")] Image image)
        {
            if (id != image.ImageId)
            {
                return NotFound();
